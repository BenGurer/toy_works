function data = roiSplitGLMDataAnalysis(roiData,analName,conIndex,restrictIndex,stimFreqs,plotROIav,plotROIpTW)
...
ConBROIpTW = cal_ConBROIpTW_ConAVoxelIndex(Voxel_data{1}.Mean_Peak,runA{2},runB{2});
...
plot_compareConditions_pTW(condition_splitMean{1}, ConBROIpTW,nCols,stimFreqs);
