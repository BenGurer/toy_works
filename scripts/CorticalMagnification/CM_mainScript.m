...
thisView = script_glmAnalysis(thisView,glmInfo,glmInfo.groupNames,{'hrfBoxcar'},0,0);
...
% use AuditoryResponsive rather than created expanded ROIs
...
% export group data
% First export f-test overlay from box car
% then export all overlays from double gamma
...
%     for iSide = 1:length(subjectInfo.flatmapNames)
%             thisView = script_covertData2FlatmapSpace(thisView,glmInfo.groupNames{iGroup},'glm_hrfDoubleGamma',[],[],subjectInfo.flatmapNames{iSide});
% 
%     end
% end
