function [ x, tw_Deconv, estimate, threshold, nVoxels] = script_centredTWROIAnalysis(thisView,roiName,glmInfo)
...
[ x, tw_Deconv ] = cal_centredTWROIAverage(e,estimate.time,analysisData.d{:});
