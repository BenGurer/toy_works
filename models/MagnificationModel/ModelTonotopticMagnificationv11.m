...
for iTonoMap = 1:length(TonotopicMagnification)
    ...
    for iStimSet = 1:length(StimulusSetSpacing)
        ...
        ESTpCF = pCFEstimation (StimulusSet{iStimSet},VoxelResponse,StimulusSetSpacing{iStimSet},StimulusSetFreq{iStimSet});
...
%% Local Functions
    ...
    function response = modelNeuronalResponse (StimulusSet,StimulusLevel,CF,p,NoiseLev)
    end
end