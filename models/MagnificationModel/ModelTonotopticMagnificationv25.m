...
TonotopicMagnification = {str2func('@lcfNDLF'),str2func('@lcfNDLFe'),str2func('@lcfNDLF10'),str2func('@lcfNErb')};
TonoMag2Freq = {str2func('@lcfInvNDLF'),str2func('@lcfInvNDLFe'),str2func('@lcfInvNDLF10'),str2func('@lcfInvNErb')};
TuningWidth = { str2func('@lcfDLF'),str2func('@lcfDLFe'),str2func('@lcfDLF'),str2func('@lcfErb')};
TonotopicNames = {'Frequency Discrimination','Frequency Discrimination - e','Frequency Discrimination - 10','Equivalent Rectangular Bandwidth'};   % names for graph titles for each stimulus spacing - must be in same order as StimMagDomain and StimMagDomain2Freq variables
...
for iTonoMap = 1:length(TonotopicMagnification)
    ...
    fLeg = legend((TonotopicNames{1}),(TonotopicNames{2}),(TonotopicNames{3}),(TonotopicNames{4}),'Location','SouthEast');
    set(fLeg, 'FontSize', fFontSize./2);
end
