...
%         end
        SE=(TonotopicMagnification{iTonoMap}(pCF) - TonotopicMagnification{iTonoMap}(ESTpCF(iStimSet,:))).^2;
        MSE = mean(SE);
...
% 
properties.df = df ./ nr;    % normalise Tuning width at 1 kHz by ERB
...
% dfnomlise = [dfnomlise(1) dfnomlise(1:end)];
