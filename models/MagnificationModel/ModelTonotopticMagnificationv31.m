...
% why does converlution cause the resonse to increase so much max 100 to
% max 20000
...
for iTonoMap = 1:length(TonotopicMagnification)
    ...
    for iStimSet = 1:length(StimulusSetSpacing)
        ...
        ESTpCF = lcfCalculatepCFEstimation (StimulusSet(iStimSet,:),NeuronalHemoResponse,StimulusSetSpacing{iStimSet},StimulusSetFreq{iStimSet});
