function playNNMask_sv(opt)
% playNNMask_sv(opt); opt = 'SIM' or 'FWD'
...
ylabel('SigL (dB SPL)','FontName','Arial','FontSize',FigFnt)
xPos = lcfShift(xPos); yPos = lcfShift(yPos); xLen = lcfShift(xLen); yLen = lcfShift(yLen);
...
uicontrol('Parent',HMain,...
    ...
    'HorizontalAlignment','left',...
    'Style','text',...
    'String','Min. initial signal level (SigL0) in dB SPL:');
H2.SigL0 = uicontrol('Parent',HMain, ...
	'Units','normalized', ...
    'Position',[xPos(2) yPos(2) xLen(2) yLen(2)],...
    'BackgroundColor',[1 1 1],...
	'Callback',sprintf('%s(''SigL0'')',clbStrg),...
    'Enable','on',...
    'FontName','Arial',...
    'FontSize',EdtFnt,...
    'HorizontalAlignment','left',...
    'Style','edit',...
    'String',sprintf('%g',SigL0));
yPos = lcfShift(yPos); yPos(2) = yPos(1)-yLen(2)-0.25*YGap;
uicontrol('Parent',HMain,...
    'Units','normalized',...
    'Position',[xPos(1) yPos(2) xLen(1)*1.5 yLen(2)],...
...
yPos = lcfShift(yPos); yPos(2) = yPos(1)-yLen(2)-0.25*YGap; 
H2.MaskL = uicontrol('Parent',HMain,...
    'Units','normalized',...
    'Position',[xPos(2) yPos(2) xLen(2) yLen(2)],...
    'BackgroundColor',lGrey,...
    'FontName','Arial',...
    ...
    'HorizontalAlignment','left',...
    'Style','text',...
    'String','Masker level (MaskL) in dB SPL/ERB:');
yPos = lcfShift(yPos); yPos(2) = yPos(1)-yLen(2)-0.25*YGap; 
