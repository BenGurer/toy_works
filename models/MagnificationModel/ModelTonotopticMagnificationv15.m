...
NoiseLev = 0; % level of noise in system
...
%         StimLev = StimulusLevel(iStimSet,:);
        for z = 1:length(StimulusSet)
            NeuronalResponse(z,:) = lcfModelNeuronalResponse(StimulusSet(iStimSet,z),StimulusLevel(iStimSet,z),NeuronalProperties.CF,NeuronalProperties.p,NoiseLev);
