...
nStimuli = 15;   % number of stimulus
...
for iTonoMap = 1:length(TonotopicMagnification)
    ...
    NeuronalProperties = lcfCreateTonotopicProperties(Fn,TWn,f,TuningWidth{iTonoMap},TonotopicMagnification{iTonoMap},TonoMag2Freq{iTonoMap});
...
%% Local Functions
function properties = lcfCreateTonotopicProperties(Fn,TWn,f,G,Gn,Gi)
TWn = 0.1;
Fn = 2;
