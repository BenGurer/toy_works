...
for iTonoMap = 1:length(TonotopicMagnification)
    ...
    NeuronalProperties(iTonoMap) = CreateTonotopicProperties(LowFreq,HighFreq,nNeurons,C,TonotopicMagnification{iTonoMap},TonoMag2Freq{iTonoMap},TuningWidth{iTonoMap},nr);    %(LowFreq,HighFreq,nVoxels,C,magDomain,magScale2F,magFilterWidth)      
...
%         VoxelResponse
        ...
        pCF = pCFEstimation (StimulusSet,VoxelResponse,StimulusSetSpacing{iStimSet},StimulusSetFreq{iStimSet});
