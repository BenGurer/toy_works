...
VoxelMagSpace = {str2func('@(NErb)lcfNErb(f)'),str2func('@(FreqSel)FreqSelectMagDom(f)')};
VoxelMagSpace2Freq = {str2func('@(f)lcfInvNErb(NErb)'),str2func('@(f)FreqSelectMagDom2Freq(FreqSel)')};
VoxelFilterWidth = {str2func('@(f)lcfErb(NErb)'),str2func('@(f)FreqSelectMagDom2Freq(FreqSel)')};

%% Stimuli Magnification domain functions
% magDomain,magScale2F,magFilterWidth
StimMagDomain = {'LinMagDom','LogMagDom','lcfNErb','FreqSelectMagDom'};
StimMagDomain2Freq = {'LinMagDom2Freq','LogMagDom2Freq','lcfInvNErb','FreqSelectMagDom2Freq'};
