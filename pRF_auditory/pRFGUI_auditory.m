...
paramsInfo{end+1} = {'estimationSupersampling',1,'minmax=[0 100]','incdec=[-1 1]','Supersample design matrix'};
paramsInfo{end+1} = {'acquisitionDelay',1,'minmax=[0 100]','incdec=[-1 1]','Image acquistion delay'};
