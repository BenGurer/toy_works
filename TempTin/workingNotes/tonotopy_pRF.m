...
for i = 1:nGroups
    ...
    x = x+nGroups;
%     y = 0;
%     %     for ii = 1:params.nBaseline
%     stimulus(x+y) = blockStimulus(x+y);
%     stimulus(x+y+1) = blockStimulus(x+y+1);
%     stimulus(x+y+2) = blockStimulus(x+y+2);
%     stimulus(x+y+3) = blockStimulus(x+y+3);
%     y = y+1;
%     stimulus(x+y) = blockStimulus(x+y);
%     stimulus(x+y+1) = blockStimulus(x+y+1);
%     stimulus(x+y+2) = blockStimulus(x+y+2);
...
%     stimulus(x+y+3) = blockStimulus(x+y+3);
%     y = y+5;
%     stimulus(x+y) = silenceStimulus;
%     stimulus(x+y+1) = silenceStimulus;
%     stimulus(x+y+2) = silenceStimulus;
%     stimulus(x+y+3) = silenceStimulus;
%     %     end
%     x = x+nGroups;
end
