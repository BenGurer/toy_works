...
filePath = 'N:\matlab\C84PRO\MATLAB\';

temp = input('Skip EEG? (y/n):', 's');
switch temp
    case 'y'
        skip = 1;
    case 'n'
...
%% Load RP2
RP = Circuit_Loader('N:\matlab\C84PRO\C84PROv11.rcx'); % Runs Circuit_Loader
...
function TinntusInduce (RP, expData, duration)
...
%% Create GUI's to present tinnitus tester
...
function data = spectral (RP, expData)
disp('Tinnitus characterisation ... Spectral')
done = 0;
data.Spectral = NaN (1);
data.InduceTime = 0;
while (done == 0)
    %% Start TDT playback
    SpectralPlayer (RP, expData);
    
    %% Load GUI for participant response and parameter updates
    [f,df] = SpectralGUI (RP, expData);
    uiwait(f)
    TinStat = getappdata(df,'TinStat');
    
    data.Spectral = getappdata(df,'Response');
    ...
    elseif (TinStat == 1)
        disp ('Bandwidth complete')
        done = 1;
    end
    
end

    function [f, df] = SpectralGUI (RP, expData)
        ...
        pos = genSpectralGUILayout (f, expData);
        ...
        txt = uicontrol(f,'Style','text',...
            'Position',pos.QTXT,...
            'String','Which sound of the sounds below does your tinnitus sensation sound more like?',...
            'backgroundcolor',[0.5, 0.5, 0.5],...
            'ForegroundColor',[1 1 1],...
            'FontSize', 60,...
            'FontUnits', 'normalized',...
        ...
        % Add a text uicontrol to label the slider.
        TONALtxt = uicontrol(f,'Style','text',...
            'Position',pos.TonalTXT,...
            'String','Tonal',...
            'backgroundcolor',[0.5, 0.5, 0.5],...
            'FontSize', 65,...
            'FontUnits', 'normalized',...
            'FontWeight','bold');
        % Add a text uicontrol to label the slider.
        RINGINGtxt = uicontrol(f,'Style','text',...
            'Position',pos.RingingTXT,...
            'String','Ringing',...
            'backgroundcolor',[0.5, 0.5, 0.5],...
            'ForegroundColor','cyan',...
            'FontSize', 65,...
            ...
            'FontWeight','bold');
        % Add a text uicontrol to label the slider.
        HISSINGtxt = uicontrol(f,'Style','text',...
            'Position',pos.HissingTXT,...
            'String','Hissing',...
            'backgroundcolor',[0.5, 0.5, 0.5],...
            'FontSize', 65,...
            'FontUnits', 'normalized',...
        ...
        function CurLoc (val)
            ...
            switch val
                case -1
                    disp(-1)
                    set (TONALtxt, 'ForegroundColor', 'cyan');
                    set (RINGINGtxt, 'ForegroundColor', 'k');
                    set (HISSINGtxt, 'ForegroundColor', 'k');
                ...
                case 0
                    disp(0)
                    set (TONALtxt, 'ForegroundColor', 'k');
                    set (RINGINGtxt, 'ForegroundColor', 'cyan');
                    set (HISSINGtxt, 'ForegroundColor', 'k');
                    ...
                    LPfreq = freq + BW;
                    HPfreq = freq - BW;
                    FilterComp = abs(10*log10(BW/(expData.SF/2)));
                    RP.SoftTrg(2);
                    RP.SetTagVal('SourceChannel',Switch);
                ...
                case 1
                    ...
                    set (TONALtxt, 'ForegroundColor', 'k');
                    set (RINGINGtxt, 'ForegroundColor', 'k');
                    set (HISSINGtxt, 'ForegroundColor', 'cyan');
                    ...
                    RP.SetTagVal('SourceChannel',Switch);
                    RP.SetTagVal('FilterComp',FilterComp);
                    RP.SetTagVal('FilterFreq',freq);
                    RP.SetTagVal('HissBW',BW);
                    pause(0.4)
                    RP.SoftTrg(1);
        ...
        function pos = genSpectralGUILayout (f, expData)
            ...
            pos.TonalTXT = [(scnsize(3).*0.25) - (txtSizex./2),...
                (scnsize(4).*0.4) - (txtSizey./2),...
                txtSizex,...
                txtSizey];
            
            pos.RingingTXT = [(scnsize(3).*0.5) - (txtSizex./2),...
                (scnsize(4).*0.4) - (txtSizey./2),...
                txtSizex,...
                txtSizey];
            
            pos.HissingTXT = [(scnsize(3).*0.75) - (txtSizex./2),...
                (scnsize(4).*0.4) - (txtSizey./2),...
                txtSizex,...
                txtSizey];
        end
    ...
    function SpectralPlayer (RP, expData)
...
function data = loudness (RP, expData, Spectral)
disp('Tinnitus characterisation ... Loudness')
%% n = number of frequencies to test
...
while (done == 0)
    for i = (q:test.iTrial)
        ...
        %% Start TDT playback
        LoudnessPlayer (RP, expData, freq, Spectral, RingBWComp, HissBWComp);
        
        %% Load GUI for participant response and parameter updates
        [f,df] = LoudnessGUI (RP, expData.NomLev, expData.HB7Gain);
        uiwait(f)
        TinStat = getappdata(df,'TinStat');
...
close (df)
    ...
    function [f,df] = LoudnessGUI (RP, NomLev, HB7Gain)
        ...
        pos = genLoudnessGUILayout (f, expData);
        ...
        txt = uicontrol(f,'Style','text',...
            'Position',pos.QTXT,...
            'String','Adjust the LOUDNESS of this sound until it is the same LOUDNESS as your tinnitus',...
            'backgroundcolor',[0.5, 0.5, 0.5],...
            'ForegroundColor',[1 1 1],...
            'FontSize', 72,...
            'FontUnits', 'normalized',...
        ...
        function ampchange (valCurrent, valUpdate)
            
            %         NomLev = 109.0397;
            %         HB7Gain = -15;
            
            a =10^((valCurrent-NomLev-HB7Gain)/20); % current amp value
            b =10^((valUpdate-NomLev-HB7Gain)/20); % desired/updated amp value
            n = 5; % steps between values
            y = linspace(a,b,n);
        ...
        function pos = genLoudnessGUILayout (f, expData)
            ...
            pos.LeftTXT = [(scnsize(3).*0.25) - (txtSizex./2),...
                (scnsize(4).*0.4) - (txtSizey./2),...
                txtSizex,...
                txtSizey];
            
            pos.BothTXT = [(scnsize(3).*0.5) - (txtSizex./2),...
                (scnsize(4).*0.4) - (txtSizey./2),...
                txtSizex,...
                txtSizey];
            
            pos.RightTXT = [(scnsize(3).*0.75) - (txtSizex./2),...
                (scnsize(4).*0.4) - (txtSizey./2),...
                txtSizex,...
                txtSizey];
    ...
    function LoudnessPlayer (RP, expData, freq, Spectral, RingBWComp, HissBWComp)
        ...
        switch Spectral
            ...
            case 0
                ...
                RP.SetTagVal('RingFilterComp',FilterComp);
            ...
            case 1
                ...
                RP.SetTagVal('HissFilterComp', FilterComp);
...
function CharaInstructions (expData)
disp('Characterisation Instructions')

%% Load GUI for participant response and parameter updates
[f] = CharaInstructionsGUI  (expData);
uiwait(f)


    function [f] = CharaInstructionsGUI (expData)
        ...
        txt1 = uicontrol(f,'Style','text',...
            'Position',pos.TXT1,...
            'String','We will now present the auditory stimuli again.',...
            'backgroundcolor',[0.5, 0.5, 0.5],...
            'ForegroundColor',[1 1 1],...
            'FontSize', 60,...
            'FontUnits', 'normalized',...
        ...
        txt2 = uicontrol(f,'Style','text',...
            'Position',pos.TXT2,...
            'String','Once the presentation is complate, the tinnitus characterisation will begin. If at any stage your tinnitus perception reduces to a level that makes the characterisation difficult to perform, press the yellow button.',...
            'backgroundcolor',[0.5, 0.5, 0.5],...
            'ForegroundColor',[1 1 1],...
            'FontSize', 60,...
            'FontUnits', 'normalized',...
        ...
        function data = genLocalizeGUILayout (f, expData)
            ...
            data.SelectBTN = [(scnsize(3).*0.4) - (butSizeX./2),...
                (scnsize(4).*0.15) - (butSizey./2),...
                butSizeX,...
                butSizey];
...
function TinnitusTesterInstructions (expData)
disp('Characterisation Instructions')
...
uiwait(f)
    ...
    function [f] = CharaInstructionsGUI (expData)
        ...
        txt1 = uicontrol(f,'Style','text',...
            'Position',pos.TXT1,...
            'String','We will now begin the tinnitus characterisation.',...
            'backgroundcolor',[0.5, 0.5, 0.5],...
            'ForegroundColor',[1 1 1],...
            'FontSize', 60,...
            'FontUnits', 'normalized',...
...
function LoudnessInstructions (expData)
disp('Tinnitus characterisation ... Loudness instructions')

%% Loudness instructions
[f] = LoudnessInstructionsGUI  (expData);
uiwait(f)

    function [f] = LoudnessInstructionsGUI (expData)
        ...
        txt1 = uicontrol(f,'Style','text',...
            'Position',pos.TXT1,...
            'String','We are now going to measure the LOUDNESS of your tinnitus by presenting several sounds.',...
            'backgroundcolor',[0.5, 0.5, 0.5],...
            'ForegroundColor',[1 1 1],...
            'FontSize', 60,...
            'FontUnits', 'normalized',...
        ...
        txt2 = uicontrol(f,'Style','text',...
            'Position',pos.TXT2,...
            'String','Using the dial, match the LOUDNESS of each sound, ignoring its pitch, to your tinnitus by adjusting the slider.',...
            'backgroundcolor',[0.5, 0.5, 0.5],...
            'ForegroundColor',[1 1 1],...
            'FontSize', 60,...
            'FontUnits', 'normalized',...
        ...
        txt3 = uicontrol(f,'Style','text',...
            'Position',pos.TXT3,...
            'String','When ready, press the dial to hear the first sound.',...
            'backgroundcolor',[0.5, 0.5, 0.5],...
            'ForegroundColor',[1 1 1],...
            'FontSize', 60,...
            'FontUnits', 'normalized',...
...
function LikenessInstructions (expData)
disp('Tinnitus characterisation ... Likeness instructions')

[f] = LikenessInstructionsGUI  (expData);
uiwait(f)

    function [f] = LikenessInstructionsGUI (expData)
        ...
        pos = genLocalizeGUILayout (expData);
        ...
        txt1 = uicontrol(f,'Style','text',...
            'Position',pos.TXT1,...
            'String','We are now going to present several sounds differing in PITCH.',...
            'backgroundcolor',[0.5, 0.5, 0.5],...
            'ForegroundColor',[1 1 1],...
            'FontSize', 60,...
            'FontUnits', 'normalized',...
        ...
        txt2 = uicontrol(f,'Style','text',...
            'Position',pos.TXT2,...
            'String','Using the dial, rate the similarity of each PITCH to your tinnitus by adjusting the slider.',...
            'backgroundcolor',[0.5, 0.5, 0.5],...
            'ForegroundColor',[1 1 1],...
            'FontSize', 60,...
            'FontUnits', 'normalized',...
